...
class BirinciSeviye:
    def __init__(self, root, screen_width, screen_height, game_duration):
        ...
        pygame.init()  # pygame video sistemini başlat
        self.screen = pygame.display.set_mode((screen_width, screen_height))
        pygame.display.set_caption("Birinci Seviye")
        ...
        self.speed_increase_threshold = 10  # Her 10 puanda bir balon hızı artacak
        self.balloon_frequency = 50  # Balon düşme sıklığı (oyun hızına bağlı olarak ayarlanabilir)
        self.balloon_frequency_increase = 10  # Her 10 puanda bir balon düşme sıklığı artacak
        self.balloon_speed_increase =0.05 # Her 10 puanda bir balon hızı artacak miktar
    ...
    def main_loop(self):
        while self.running:
            ...
            if self.balloon_frequency <= 0:
                self.balloon_frequency = 1  # Negatif değerlere düşmemesi için bir alt sınır
...
if __name__ == "__main__":
    birinci_seviye = BirinciSeviye(None, 800, 600, 30)  
