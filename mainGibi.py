...
def main():
    root = tk.Tk()
    root.title("Oyun Seçenekleri")

    # Butonları oluştur
    oyna_button = tk.Button(root, text="Oyna", command=start_game)
    meydan_okuma_button = tk.Button(root, text="Meydan Okuma", command=start_game)
    magaza_button = tk.Button(root, text="Mağaza", command=start_game)
    ayarlar_button = tk.Button(root, text="Ayarlar", command=start_game)

    # Butonları arayüze yerleştir
    oyna_button.pack(pady=70)
    meydan_okuma_button.pack(pady=70)
    magaza_button.pack(pady=70)
    ayarlar_button.pack(pady=30)
